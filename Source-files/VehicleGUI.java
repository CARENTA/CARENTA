...
public class VehicleGUI {
        ...
        public void search() {
        	...
        	try{
                ...
                if (enteredRegNbr.length() == 6){
                vehicle = controller.findVehicle(enteredRegNbr.toUpperCase());
                ...
                else {JOptionPane.showMessageDialog(null, "Vänligen fyll i fältet korrekt (ex. ABC123)");}
        	}
        
        	catch (Exception e) {JOptionPane.showMessageDialog(null, "Fordon finns ej! Vänligen fyll i fältet korrekt (ex. ABC123)");}
        ...
        public void saveEdit() {
        	...
        	try{
                if(fieldRegNbr.getText().equals("") || fieldModel.getText().equals("") || fieldPrice.getText().equals("") || fieldInfo.getText().equals("")){
                              JOptionPane.showMessageDialog(null, "Alla fält måste var korrekt ifyllda");                           
                }
                if (fieldRegNbr.getText().length() != 6) {
                	JOptionPane.showMessageDialog(null, "Vänligen fyll i  korrekt (ex. ABC123)");
                }
                
                int checkPrice = Integer.parseInt(fieldPrice.getText());
                if (checkPrice < 0){
                	JOptionPane.showMessageDialog(null, "Vänligen fyll i ett gilltigt pris");            	
                }
        	...
        	catch (Exception e) { JOptionPane.showMessageDialog(null, "Alla fält måste var korrekt ifyllda"); }
        ...
        public void create() {
        	...
        	catch (Exception e){ JOptionPane.showMessageDialog(null, "Vänligen fyll ut alla fält korrekt");
        }
    }
}
